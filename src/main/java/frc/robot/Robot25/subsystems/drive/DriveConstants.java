...
public class DriveConstants {
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.538);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.5 + 0.483);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.031);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.5 + 0.729);
