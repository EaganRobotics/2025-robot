...
public class DriveConstants {
  ...
  public static class Sim {
    ...
    private static final Voltage kSteerFrictionVoltage = Volts.of(0.15); // suggested range 0.3 -
                                                                         // 0.5
    private static final Voltage kDriveFrictionVoltage = Volts.of(0.05); // suggested range 0.6 -
                                                                         // 0.8
  }
