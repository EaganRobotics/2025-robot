...
public class Outtake extends SubsystemBase {
   ...
   * - look if timeout or sensor is ending the function
   * - see if we are applying output but still not scoring, lineup with video
   *
   * TODO: get rid of debouce on until() call since we recently added a falling (true -> false) debounce to the trigger anyway
   */
