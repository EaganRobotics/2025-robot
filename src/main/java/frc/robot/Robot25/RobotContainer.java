...
public class RobotContainer extends frc.lib.RobotContainer {
  ...
  public RobotContainer() {
    ...
    switch (SimConstants.CURRENT_MODE) {
      case REAL:
        ...
        vision = new Vision(drive, new VisionIOLimelight("limelight-one", () -> drive.getPose().getRotation()));
        break;
      case SIM:
  ...
  private void configureButtonBindings() {
    ...
    outtake.setDefaultCommand(outtake.autoQueueCoral(DriverController.leftBumper())
